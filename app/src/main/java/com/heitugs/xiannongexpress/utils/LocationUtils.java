...
import com.heitugs.xiannongexpress.listener.MyLocationListener;
...
public class LocationUtils implements MyLocationListener.OnLocationResultListener {
    ...
    public void onResultData(Map<String, Object> map) {
        ...
        if (!map.keySet().contains("address")) {
            // 传入经纬度
            getAddress(Double.parseDouble(map.get("latitude").toString()), Double.parseDouble(map.get("lontitude").toString()));
        } else {
